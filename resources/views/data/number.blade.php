    ...
    <div class="card" style="padding: 10px">
        ...
        <div class="d-flex justify-content-end mb-3">
            ...
            <button id="myButton" class="btn btn-icon btn-primary ms-2" data-bs-toggle="tooltip" data-bs-offset="0,4"
                data-bs-placement="right" data-bs-html="true" title="<span>Kirim Pesan Massal</span>">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($number as $item)
                        <tr>
                            ...
                            <td>{{ $item->number }}</td>
                            <td>
                                <img src="{{ $item->message->img_url }}" alt="Gambar Pesan"
                    ...
                    <ul class="pagination justify-content-center">
                        ...
                        @else
                            <li class="page-item prev">
                                <a class="page-link" href="{{ $number->previousPageUrl() }}"><i
                                        class="tf-icon bx bx-chevrons-left"></i></a>
                            </li>
                        @endif
                        ...
                        @if ($number->hasMorePages())
                            <li class="page-item next">
                                <a class="page-link" href="{{ $number->nextPageUrl() }}"><i
