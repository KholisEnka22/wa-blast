                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <marquee behavior="scroll" direction="left" scrollamount="3" scrolldelay="5" onmouseover="this.stop()" onmouseout="this.start()">
                            Hubungi kami untuk jasa layanan whatsapp blast, promo whatsapp blast, WA blast, whatsapp marketing, whatsapp automation, dan jasa whatsapp lainnya. <a href="https://wa.me/6281554850403" target="_blank">Klik disini</a> untuk menghubungi kami.
                        </marquee>
